...
# modified by Michael M. Pieler to include a Squeeze-Excite block (https://github.com/MicPie)
...
__all__ = ['SEMXResNet', 'semxresnet18', 'semxresnet34', 'semxresnet50', 'semxresnet101', 'semxresnet152']
...
class SEMXResNet(nn.Sequential):
...
def semxresnet(expansion, n_layers, name, pretrained=False, **kwargs):
    model = SEMXResNet(expansion, n_layers, **kwargs)
    if pretrained: 
...
for n,e,l in [
    ...
    name = f'semxresnet{n}'
    setattr(me, name, partial(semxresnet, expansion=e, n_layers=l, name=name))
